...
# loops through all .md files in "/MD-Files" folder 
# and generates .html files in the main folder
directory = './MD-Files'
for md_filename in os.listdir(directory):
    if md_filename.endswith('.md'):
        title = md_filename.replace(".md","")
        title = title.capitalize()
        with open(os.path.join(directory, md_filename), "r") as file:
        ...
        with open(md_filename.replace(".md", ".html"), "w") as output_file:
